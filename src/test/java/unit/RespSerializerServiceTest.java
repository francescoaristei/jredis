...
public class RespSerializerServiceTest {
    ...
    class RespSerializerSimpleRespTypesTest {
        ...
        public void serializeOnSimpleString() {
            ...
            assertEquals(responseString, serializer.serializeSimpleString(simpleStringToSerialize).toString());
        }
        ...
        public void serializeOnSimpleError() {
            ...
            assertEquals(responseString, serializer.serializeSimpleError(simpleErrorToSerialize).toString());
        }
        ...
        public void serializeOnRespInteger() {
            ...
            assertEquals(responseString, serializer.serializeRespInteger(respIntegerToSerialize).toString());
        }
        ...
        public void serializeOnBulkString() {
            ...
            assertEquals(responseString, serializer.serializeBulkString(bulkStringToSerialize).toString());
        }
        ...
        public void serializeOnRespNull() {
            ...
            assertEquals(responseString, serializer.serializeRespNull(respNullToSerialize).toString());
        }
    }
    ...
    class RespSerializerAggregateRespTypesTest {
        ...
        public void serializeOnRespArray() {
            ...
            assertEquals(responseString, serializer.serializeRespArray(respArrayToSerialize).toString());
        }
